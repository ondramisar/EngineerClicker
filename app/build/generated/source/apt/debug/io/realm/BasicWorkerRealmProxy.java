...
public class BasicWorkerRealmProxy extends com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker
    ...
    private void injectObjectContext() {
        ...
        this.proxyState = new ProxyState(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class, this);
    ...
    @SuppressWarnings("cast")
    public static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker obj = null;
        if (update) {
            Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class);
            ...
            if (rowIndex != TableOrView.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("name")) {
                if (json.isNull("name")) {
                    obj = (io.realm.BasicWorkerRealmProxy) realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.BasicWorkerRealmProxy) realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class, json.getString("name"), true, excludeFields);
                }
            } else {
    ...
    public static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker obj = new com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker();
        reader.beginObject();
    ...
    public static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker copyOrUpdate(Realm realm, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker) cachedRealmObject;
        } else {
            com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker realmObject = null;
    ...
    public static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker copy(Realm realm, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker realmObject = realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class, ((BasicWorkerRealmProxyInterface) newObject).realmGet$name(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class);
        long tableNativePtr = table.getNativeTablePointer();
        BasicWorkerColumnInfo columnInfo = (BasicWorkerColumnInfo) realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class);
        long pkColumnIndex = table.getPrimaryKey();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        BasicWorkerColumnInfo columnInfo = (BasicWorkerColumnInfo) realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class);
        long pkColumnIndex = table.getPrimaryKey();
        com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker object = null;
        while (objects.hasNext()) {
            object = (com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker.class);
    ...
    public static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker createDetachedCopy(com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker)cachedObject.object;
            } else {
                unmanagedObject = (com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker();
    ...
    static com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker update(Realm realm, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker realmObject, com.companybest.ondra.engineerclicker.Models.Workers.BasicWorker newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ((BasicWorkerRealmProxyInterface) realmObject).realmSet$numberOf(((BasicWorkerRealmProxyInterface) newObject).realmGet$numberOf());
        ((BasicWorkerRealmProxyInterface) realmObject).realmSet$cost(((BasicWorkerRealmProxyInterface) newObject).realmGet$cost());
        return realmObject;
    }
