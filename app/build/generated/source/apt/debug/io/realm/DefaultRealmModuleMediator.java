...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    public Table createTable(Class<? extends RealmModel> clazz, SharedRealm sharedRealm) {
        ...
        if (clazz.equals(com.companybest.ondra.engineerclicker.Models.Upgrade.class)) {
            return io.realm.UpgradeRealmProxy.initTable(sharedRealm);
        } else if (clazz.equals(com.companybest.ondra.engineerclicker.Models.Machine.class)) {
