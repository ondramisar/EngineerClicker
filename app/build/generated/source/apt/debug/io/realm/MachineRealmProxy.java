...
public class MachineRealmProxy extends com.companybest.ondra.engineerclicker.Models.Machine
    ...
    private void injectObjectContext() {
        ...
        this.proxyState = new ProxyState(com.companybest.ondra.engineerclicker.Models.Machine.class, this);
    ...
    @SuppressWarnings("cast")
    public static com.companybest.ondra.engineerclicker.Models.Machine createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.companybest.ondra.engineerclicker.Models.Machine obj = null;
        if (update) {
            Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Machine.class);
            ...
            if (rowIndex != TableOrView.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Machine.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("name")) {
                if (json.isNull("name")) {
                    obj = (io.realm.MachineRealmProxy) realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Machine.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.MachineRealmProxy) realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Machine.class, json.getString("name"), true, excludeFields);
                }
            } else {
    ...
    public static com.companybest.ondra.engineerclicker.Models.Machine createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        com.companybest.ondra.engineerclicker.Models.Machine obj = new com.companybest.ondra.engineerclicker.Models.Machine();
        reader.beginObject();
    ...
    public static com.companybest.ondra.engineerclicker.Models.Machine copyOrUpdate(Realm realm, com.companybest.ondra.engineerclicker.Models.Machine object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.companybest.ondra.engineerclicker.Models.Machine) cachedRealmObject;
        } else {
            com.companybest.ondra.engineerclicker.Models.Machine realmObject = null;
    ...
    public static com.companybest.ondra.engineerclicker.Models.Machine copy(Realm realm, com.companybest.ondra.engineerclicker.Models.Machine newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.companybest.ondra.engineerclicker.Models.Machine) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.companybest.ondra.engineerclicker.Models.Machine realmObject = realm.createObjectInternal(com.companybest.ondra.engineerclicker.Models.Machine.class, ((MachineRealmProxyInterface) newObject).realmGet$name(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.companybest.ondra.engineerclicker.Models.Machine object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Machine.class);
        long tableNativePtr = table.getNativeTablePointer();
        MachineColumnInfo columnInfo = (MachineColumnInfo) realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Machine.class);
        long pkColumnIndex = table.getPrimaryKey();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MachineColumnInfo columnInfo = (MachineColumnInfo) realm.schema.getColumnInfo(com.companybest.ondra.engineerclicker.Models.Machine.class);
        long pkColumnIndex = table.getPrimaryKey();
        com.companybest.ondra.engineerclicker.Models.Machine object = null;
        while (objects.hasNext()) {
            object = (com.companybest.ondra.engineerclicker.Models.Machine) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.companybest.ondra.engineerclicker.Models.Machine object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.companybest.ondra.engineerclicker.Models.Machine.class);
    ...
    public static com.companybest.ondra.engineerclicker.Models.Machine createDetachedCopy(com.companybest.ondra.engineerclicker.Models.Machine realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.companybest.ondra.engineerclicker.Models.Machine unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.companybest.ondra.engineerclicker.Models.Machine)cachedObject.object;
            } else {
                unmanagedObject = (com.companybest.ondra.engineerclicker.Models.Machine)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.companybest.ondra.engineerclicker.Models.Machine();
    ...
    static com.companybest.ondra.engineerclicker.Models.Machine update(Realm realm, com.companybest.ondra.engineerclicker.Models.Machine realmObject, com.companybest.ondra.engineerclicker.Models.Machine newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ((MachineRealmProxyInterface) realmObject).realmSet$numberOf(((MachineRealmProxyInterface) newObject).realmGet$numberOf());
        ((MachineRealmProxyInterface) realmObject).realmSet$numberOfWorkersOnMachine(((MachineRealmProxyInterface) newObject).realmGet$numberOfWorkersOnMachine());
        ((MachineRealmProxyInterface) realmObject).realmSet$cost(((MachineRealmProxyInterface) newObject).realmGet$cost());
        ((MachineRealmProxyInterface) realmObject).realmSet$maxTimerOfMachine(((MachineRealmProxyInterface) newObject).realmGet$maxTimerOfMachine());
